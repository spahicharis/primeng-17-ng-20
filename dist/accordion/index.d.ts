...
import { TemplateRef, AfterContentInit, OnDestroy, ElementRef, ChangeDetectorRef, EventEmitter, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class AccordionTab implements AfterContentInit, OnDestroy {
    el: ElementRef<any>;
 ...
 * @group Components
 */
declare class Accordion implements BlockableUI, AfterContentInit, OnDestroy {
    el: ElementRef<any>;
    changeDetector: ChangeDetectorRef;
    /**
    ...
    focusedElementIsAccordionHeader(): boolean;
...
export type { AccordionTabCloseEvent, AccordionTabOpenEvent, AccordionTemplates };
