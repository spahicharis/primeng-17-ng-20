...
import { OnDestroy, DoCheck, ElementRef, NgZone, PipeTransform, AfterContentInit, OnInit, TemplateRef, EventEmitter, QueryList } from '@angular/core';
import * as i7 from 'primeng/api';
import { PrimeNGConfig, OverlayService, PrimeTemplate } from 'primeng/api';
...
import * as i5 from 'primeng/icons/eyeslash';
import * as i6 from 'primeng/icons/eye';
 ...
 * @group Components
 */
declare class PasswordDirective implements OnDestroy, DoCheck {
    private document;
    private platformId;
    private renderer;
    el: ElementRef<any>;
 ...
 * @group Components
 */
declare class Password implements AfterContentInit, OnInit {
    private document;
    private platformId;
    private renderer;
    private cd;
    ...
    onEyeIconPress(event: KeyboardEvent): void;
...
declare class PasswordModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<PasswordModule, [typeof PasswordDirective, typeof Password, typeof MapperPipe], [typeof i1.CommonModule, typeof i2.InputTextModule, typeof i3.AutoFocusModule, typeof i4.TimesIcon, typeof i5.EyeSlashIcon, typeof i6.EyeIcon], [typeof PasswordDirective, typeof Password, typeof i7.SharedModule]>;
