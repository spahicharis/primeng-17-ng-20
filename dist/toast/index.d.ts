...
import { TemplateRef, AfterViewInit, OnDestroy, EventEmitter, ElementRef, OnInit, AfterContentInit, QueryList } from '@angular/core';
...
declare class ToastItem implements AfterViewInit, OnDestroy {
    private zone;
    private config;
 ...
 * @group Components
 */
declare class Toast implements OnInit, AfterContentInit, OnDestroy {
    private document;
    private renderer;
