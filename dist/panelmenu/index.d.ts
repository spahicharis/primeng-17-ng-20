...
import { AfterContentInit, QueryList, ElementRef, TemplateRef, EventEmitter, OnChanges, SimpleChanges } from '@angular/core';
...
declare class PanelMenuList implements OnChanges {
    private el;
    panelId: string | undefined;
    id: string | undefined;
    items: any[];
 ...
 * @group Components
 */
declare class PanelMenu implements AfterContentInit {
    private cd;
    /**
