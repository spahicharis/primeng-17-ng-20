...
import { TemplateRef, AfterContentInit, OnInit, OnDestroy, OnChanges, ElementRef, ChangeDetectorRef, NgZone, EventEmitter, QueryList, SimpleChanges, AfterViewInit } from '@angular/core';
import * as i15 from 'primeng/api';
import { FilterMetadata, TreeNode, TreeTableNode, LazyLoadMeta, SortMeta, BlockableUI, FilterService, PrimeNGConfig, ScrollerOptions, PrimeTemplate } from 'primeng/api';
 ...
 * @group Components
 */
declare class TreeTable implements AfterContentInit, OnInit, OnDestroy, BlockableUI, OnChanges {
    private document;
    private renderer;
    el: ElementRef<any>;
...
declare class TTScrollableView implements AfterViewInit, OnDestroy {
    ...
    getMergedTableStyles(contentStyle: any): any;
...
declare class TreeTableCellEditor implements AfterContentInit {
    tt: TreeTable;
...
declare class TreeTableToggler {
    tt: TreeTable;
    private config;
    rowNode: any;
