...
import { TemplateRef, OnInit, OnDestroy, ElementRef, Renderer2, ChangeDetectorRef, EventEmitter, QueryList } from '@angular/core';
 ...
 * @group Interface
 */
interface CalendarResponsiveOptions {
    /**
 ...
 * @group Events
 */
interface CalendarYearChangeEvent {
    /**
     * New month.
     */
    month?: number;
...
declare const CALENDAR_VALUE_ACCESSOR: any;
/**
 * Calendar also known as DatePicker, is a form component to work with dates.
 * @group Components
 */
declare class Calendar implements OnInit, OnDestroy, ControlValueAccessor {
    private document;
    el: ElementRef<any>;
    renderer: Renderer2;
    ...
    static ngAcceptInputType_stepYearPicker: unknown;
...
export type { CalendarMonthChangeEvent, CalendarResponsiveOptions, CalendarTemplates, CalendarTypeView, CalendarYearChangeEvent, LocaleSettings, Month, NavigationState };
