...
import { ElementRef, TemplateRef, OnInit, EventEmitter, AfterContentInit, QueryList, SimpleChanges } from '@angular/core';
import { AnimationEvent } from '@angular/animations';
import * as i3 from 'primeng/api';
import { PrimeNGConfig, OverlayService, OverlayOptions, PrimeTemplate } from 'primeng/api';
...
declare class CascadeSelectSub implements OnInit {
    private el;
 ...
 * @group Components
 */
declare class CascadeSelect implements OnInit, AfterContentInit {
    private el;
    private cd;
    private config;
