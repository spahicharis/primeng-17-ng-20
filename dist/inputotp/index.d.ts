...
import { TemplateRef, AfterContentInit, ChangeDetectorRef, EventEmitter, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class InputOtp implements AfterContentInit {
...
export type { InputOtpChangeEvent, InputOtpTemplateEvents, InputOtpTemplates };
