...
import { AfterContentInit, OnDestroy, ElementRef, Renderer2, ChangeDetectorRef, EventEmitter, QueryList, TemplateRef } from '@angular/core';
import * as i1 from '@angular/common';

declare const OVERLAY_VALUE_ACCESSOR: any;
/**
 ...
 * @group Components
 */
declare class Overlay implements AfterContentInit, OnDestroy {
    private document;
    private platformId;
    el: ElementRef<any>;
    renderer: Renderer2;
    ...
    get overlayResponsiveDirection(): i2.ResponsiveOverlayDirectionType;
    get overlayEl(): any;
    get contentEl(): any;
    get targetEl(): any;
    constructor();
