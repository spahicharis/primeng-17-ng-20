...
import { forwardRef, EventEmitter, booleanAttribute, numberAttribute, Output, Input, Component, inject, ElementRef, Renderer2, ChangeDetectorRef, NgZone, signal, computed, effect, ContentChildren, ViewChild, ViewEncapsulation, ChangeDetectionStrategy, NgModule } from '@angular/core';
import { NG_VALUE_ACCESSOR } from '@angular/forms';
import * as i4 from 'primeng/api';
import { FilterService, PrimeNGConfig, TranslationKeys, PrimeTemplate, SharedModule } from 'primeng/api';
...
class DropdownItem {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: DropdownItem, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.9", type: DropdownItem, isStandalone: false, selector: "p-dropdownItem", inputs: { id: "id", option: "option", selected: ["selected", "selected", booleanAttribute], focused: ["focused", "focused", booleanAttribute], label: "label", disabled: ["disabled", "disabled", booleanAttribute], visible: ["visible", "visible", booleanAttribute], itemSize: ["itemSize", "itemSize", numberAttribute], ariaPosInset: "ariaPosInset", ariaSetSize: "ariaSetSize", template: "template", checkmark: ["checkmark", "checkmark", booleanAttribute] }, outputs: { onClick: "onClick", onMouseEnter: "onMouseEnter" }, host: { classAttribute: "p-element" }, ngImport: i0, template: `
        <li
          ...
          @if (checkmark) {
            @if (selected) {
              <CheckIcon [styleClass]="'p-dropdown-check-icon'" />
            }
            @if (!selected) {
              <BlankIcon [styleClass]="'p-dropdown-blank-icon'" />
            }
          }
          @if (!template) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: DropdownItem, decorators: [{
            type: Component,
            args: [{
...
class Dropdown {
    ...
    selectedOption;
    editableInputValue = computed(() => this.getOptionLabel(this.selectedOption) || this.modelValue() || '', ...(ngDevMode ? [{ debugName: "editableInputValue" }] : []));
    constructor() {
        effect(() => {
        ...
        <div #container [attr.id]="id" [ngClass]="containerClass" (click)="onContainerClick($event)" [ngStyle]="style" [class]="styleClass">
          @if (!editable) {
            <span
              ...
              @if (selectedItemTemplate && !isSelectedOptionEmpty()) {
          ...
          @if (isVisibleClearIcon) {
            @if (!clearIconTemplate) {
              <TimesIcon [styleClass]="'p-dropdown-clear-icon'" (click)="clear($event)" [attr.data-pc-section]="'clearicon'" />
            }
            @if (clearIconTemplate) {
              <span class="p-dropdown-clear-icon" (click)="clear($event)" [attr.data-pc-section]="'clearicon'">
          ...
          <div class="p-dropdown-trigger" role="button" aria-label="dropdown trigger" (mousedown)="onMouseDown($event)" aria-haspopup="listbox" [attr.aria-expanded]="overlayVisible ?? false" [attr.data-pc-section]="'trigger'">
            @if (loading) {
              ...
              @if (!loadingIconTemplate) {
                @if (loadingIcon) {
                  <span [ngClass]="'p-dropdown-trigger-icon pi-spin ' + loadingIcon" aria-hidden="true"></span>
                }
                @if (!loadingIcon) {
                  <span [class]="'p-dropdown-trigger-icon pi pi-spinner pi-spin'" aria-hidden="true"></span>
                }
              }
            } @else {
              @if (!dropdownIconTemplate) {
                ...
                @if (!dropdownIcon) {
                  <ChevronDownIcon [styleClass]="'p-dropdown-trigger-icon'" />
                }
              }
              @if (dropdownIconTemplate) {
          ...
          <p-overlay
            ...
            <ng-template pTemplate="content">
              <div [ngClass]="'p-dropdown-panel p-component'" [ngStyle]="panelStyle" [class]="panelStyleClass">
                ...
                @if (filter) {
                  <div class="p-dropdown-header" (click)="$event.stopPropagation()">
                    @if (filterTemplate) {
                      ...
                      <div class="p-dropdown-filter-container">
                        ...
                        @if (!filterIconTemplate) {
                          <SearchIcon [styleClass]="'p-dropdown-filter-icon'" />
                        }
                        @if (filterIconTemplate) {
                          <span class="p-dropdown-filter-icon">
                  ...
                  <ng-template #buildInItems let-items let-scrollerOptions="options">
                    <ul #items [attr.id]="id + '_list'" [attr.aria-label]="listLabel" class="p-dropdown-items" [ngClass]="scrollerOptions.contentStyleClass" [ngStyle]="scrollerOptions.contentStyle" role="listbox">
                      ...
                      @if (filterValue && isEmpty()) {
                        <li class="p-dropdown-empty-message" [ngStyle]="{ height: scrollerOptions.itemSize + 'px' }" role="option">
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: Dropdown, decorators: [{
        ...
        `, host: {
                    ...
                    }, providers: [DROPDOWN_VALUE_ACCESSOR], changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None, standalone: false, styles: ["@layer primeng{.p-dropdown{display:inline-flex;cursor:pointer;position:relative;-webkit-user-select:none;user-select:none}.p-dropdown-clear-icon{position:absolute;top:50%;margin-top:-.5rem}.p-dropdown-trigger{display:flex;align-items:center;justify-content:center;flex-shrink:0}.p-dropdown-label{display:block;white-space:nowrap;overflow:hidden;flex:1 1 auto;width:1%;text-overflow:ellipsis;cursor:pointer}.p-dropdown-label-empty{overflow:hidden;opacity:0}input.p-dropdown-label{cursor:default}.p-dropdown .p-dropdown-panel{min-width:100%}.p-dropdown-items-wrapper{overflow:auto}.p-dropdown-item{cursor:pointer;font-weight:400;white-space:nowrap;position:relative;overflow:hidden}.p-dropdown-item-group{cursor:auto}.p-dropdown-items{margin:0;padding:0;list-style-type:none}.p-dropdown-filter{width:100%}.p-dropdown-filter-container{position:relative}.p-dropdown-filter-icon{position:absolute;top:50%;margin-top:-.5rem}.p-fluid .p-dropdown{display:flex}.p-fluid .p-dropdown .p-dropdown-label{width:1%}.p-float-label .p-dropdown .p-placeholder{opacity:0}}\n"] }]
