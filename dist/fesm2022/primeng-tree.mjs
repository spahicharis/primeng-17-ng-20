...
import { inject, numberAttribute, booleanAttribute, Input, ViewEncapsulation, Component, ElementRef, ChangeDetectorRef, EventEmitter, ViewChild, ContentChildren, Output, ChangeDetectionStrategy, NgModule } from '@angular/core';
import * as i3 from 'primeng/api';
import { TreeDragDropService, PrimeNGConfig, TranslationKeys, PrimeTemplate, SharedModule } from 'primeng/api';
...
class UITreeNode {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: UITreeNode, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.9", type: UITreeNode, isStandalone: false, selector: "p-treeNode", inputs: { rowNode: "rowNode", node: "node", parentNode: "parentNode", root: ["root", "root", booleanAttribute], index: ["index", "index", numberAttribute], firstChild: ["firstChild", "firstChild", booleanAttribute], lastChild: ["lastChild", "lastChild", booleanAttribute], level: ["level", "level", numberAttribute], indentation: ["indentation", "indentation", numberAttribute], itemSize: ["itemSize", "itemSize", numberAttribute], loadingMode: "loadingMode" }, host: { classAttribute: "p-element" }, ngImport: i0, template: `
        @if (node) {
            ...
            <li
              ...
              <div
                ...
                <button type="button" [attr.data-pc-section]="'toggler'" class="p-tree-toggler p-link" (click)="toggle($event)" pRipple tabindex="-1">
                  @if (!tree.togglerIconTemplate) {
                    @if (!node.loading) {
                      @if (!node.expanded) {
                        <ChevronRightIcon [styleClass]="'p-tree-toggler-icon'" />
                      }
                      @if (node.expanded) {
                        <ChevronDownIcon [styleClass]="'p-tree-toggler-icon'" />
                      }
                    }
              ...
              @if (!tree.virtualScroll && node.children && node.expanded) {
                <ul
                  ...
                  role="group"
                  >
                  @for (childNode of node.children; track tree.trackBy(index, childNode); let firstChild = $first; let lastChild = $last; let index = $index) {
                    <p-treeNode
                      [node]="childNode"
                      [parentNode]="node"
          ...
          @if (tree.horizontal) {
            <table [class]="node.styleClass">
              <tbody>
                <tr>
                  @if (!root) {
                    <td class="p-treenode-connector">
                  ...
                  <td class="p-treenode" [ngClass]="{ 'p-treenode-collapsed': !node.expanded }">
                    <div
                      ...
                      >
                      @if (!isLeaf()) {
                        <span [ngClass]="'p-tree-toggler'" (click)="toggle($event)">
                          @if (!tree.togglerIconTemplate) {
                            @if (!node.expanded) {
                              <PlusIcon [styleClass]="'p-tree-toggler-icon'" [ariaLabel]="tree.togglerAriaLabel" />
                            }
                            @if (node.expanded) {
                              <MinusIcon [styleClass]="'p-tree-toggler-icon'" [ariaLabel]="tree.togglerAriaLabel" />
                            }
                          }
                          @if (tree.togglerIconTemplate) {
                            <span class="p-tree-toggler-icon">
                  ...
                  @if (node.children && node.expanded) {
                    <td
                      ...
                      <div class="p-treenode-children">
                        @for (childNode of node.children; track tree.trackBy($index, childNode); let firstChild = $first; let lastChild = $last) {
                          <p-treeNode [node]="childNode" [firstChild]="firstChild" [lastChild]="lastChild"></p-treeNode>
                        }
                      </div>
                    </td>
                  }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: UITreeNode, decorators: [{
            type: Component,
            args: [{
                    selector: 'p-treeNode',
                    template: `
...
class Tree {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.9", type: Tree, isStandalone: false, selector: "p-tree", inputs: { value: "value", selectionMode: "selectionMode", loadingMode: "loadingMode", selection: "selection", style: "style", styleClass: "styleClass", contextMenu: "contextMenu", layout: "layout", draggableScope: "draggableScope", droppableScope: "droppableScope", draggableNodes: ["draggableNodes", "draggableNodes", booleanAttribute], droppableNodes: ["droppableNodes", "droppableNodes", booleanAttribute], metaKeySelection: ["metaKeySelection", "metaKeySelection", booleanAttribute], propagateSelectionUp: ["propagateSelectionUp", "propagateSelectionUp", booleanAttribute], propagateSelectionDown: ["propagateSelectionDown", "propagateSelectionDown", booleanAttribute], loading: ["loading", "loading", booleanAttribute], loadingIcon: "loadingIcon", emptyMessage: "emptyMessage", ariaLabel: "ariaLabel", togglerAriaLabel: "togglerAriaLabel", ariaLabelledBy: "ariaLabelledBy", validateDrop: ["validateDrop", "validateDrop", booleanAttribute], filter: ["filter", "filter", booleanAttribute], filterBy: "filterBy", filterMode: "filterMode", filterPlaceholder: "filterPlaceholder", filteredNodes: "filteredNodes", filterLocale: "filterLocale", scrollHeight: "scrollHeight", lazy: ["lazy", "lazy", booleanAttribute], virtualScroll: ["virtualScroll", "virtualScroll", booleanAttribute], virtualScrollItemSize: ["virtualScrollItemSize", "virtualScrollItemSize", numberAttribute], virtualScrollOptions: "virtualScrollOptions", indentation: ["indentation", "indentation", numberAttribute], _templateMap: "_templateMap", trackBy: "trackBy", virtualNodeHeight: "virtualNodeHeight" }, outputs: { selectionChange: "selectionChange", onNodeSelect: "onNodeSelect", onNodeUnselect: "onNodeUnselect", onNodeExpand: "onNodeExpand", onNodeCollapse: "onNodeCollapse", onNodeContextMenuSelect: "onNodeContextMenuSelect", onNodeDrop: "onNodeDrop", onLazyLoad: "onLazyLoad", onScroll: "onScroll", onScrollIndexChange: "onScrollIndexChange", onFilter: "onFilter" }, host: { classAttribute: "p-element" }, queries: [{ propertyName: "templates", predicate: PrimeTemplate }], viewQueries: [{ propertyName: "filterViewChild", first: true, predicate: ["filter"], descendants: true }, { propertyName: "scroller", first: true, predicate: ["scroller"], descendants: true }, { propertyName: "wrapperViewChild", first: true, predicate: ["wrapper"], descendants: true }], usesOnChanges: true, ngImport: i0, template: `
              ...
              <div class="p-tree-loading-overlay p-component-overlay">
                ...
                @if (!loadingIcon) {
                  @if (!loadingIconTemplate) {
                    <SpinnerIcon [spin]="true" [styleClass]="'p-tree-loading-icon'" />
                  }
                  @if (loadingIconTemplate) {
                    <span class="p-tree-loading-icon">
            ...
            @if (getRootNode()?.length) {
              @if (virtualScroll) {
                <p-scroller
                  ...
                  <ng-template pTemplate="content" let-items let-scrollerOptions="options">
                    @if (items) {
                      <ul class="p-tree-container" [ngClass]="scrollerOptions.contentStyleClass" [style]="scrollerOptions.contentStyle" role="tree" [attr.aria-label]="ariaLabel" [attr.aria-labelledby]="ariaLabelledBy">
                        @for (rowNode of items; track trackBy($index, rowNode); let firstChild = $first) {
                          <p-treeNode
                            #treeNode
                            [level]="rowNode.level"
                            [rowNode]="rowNode"
              ...
              @if (!virtualScroll) {
                <div #wrapper class="p-tree-wrapper" [ngStyle]="{ 'max-height': scrollHeight }">
                  @if (getRootNode()) {
                    <ul class="p-tree-container" role="tree" [attr.aria-label]="ariaLabel" [attr.aria-labelledby]="ariaLabelledBy">
                      @for (node of getRootNode(); track trackBy(index, node); let firstChild = $first; let lastChild = $last; let index = $index) {
                        <p-treeNode
                          [node]="node"
                          [firstChild]="firstChild"
                          [lastChild]="lastChild"
        ...
        @if (horizontal) {
          <div [ngClass]="{ 'p-tree p-tree-horizontal p-component': true, 'p-tree-selectable': selectionMode }" [ngStyle]="style" [class]="styleClass">
            <ng-container *ngTemplateOutlet="headerTemplate"></ng-container>
            @if (loading) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: Tree, decorators: [{
            type: Component,
        ...
        `, changeDetection: ChangeDetectionStrategy.Default, encapsulation: ViewEncapsulation.None, host: {
                        class: 'p-element'
                    }, standalone: false, styles: ["@layer primeng{.p-tree-container{margin:0;padding:0;list-style-type:none;overflow:auto}.p-treenode-children{margin:0;padding:0;list-style-type:none}.p-tree-wrapper{overflow:auto}.p-treenode-selectable{cursor:pointer;-webkit-user-select:none;user-select:none}.p-tree-toggler{cursor:pointer;-webkit-user-select:none;user-select:none;display:inline-flex;align-items:center;justify-content:center;overflow:hidden;position:relative;flex-shrink:0}.p-treenode-leaf>.p-treenode-content .p-tree-toggler{visibility:hidden}.p-treenode-content{display:flex;align-items:center}.p-tree-filter{width:100%}.p-tree-filter-container{position:relative;display:block;width:100%}.p-tree-filter-icon{position:absolute;top:50%;margin-top:-.5rem}.p-tree-loading{position:relative;min-height:4rem}.p-tree .p-tree-loading-overlay{position:absolute;display:flex;align-items:center;justify-content:center;z-index:2}.p-tree-flex-scrollable{display:flex;flex:1;height:100%;flex-direction:column}.p-tree-flex-scrollable .p-tree-wrapper{flex:1}.p-tree .p-treenode-droppoint{height:4px;list-style-type:none}.p-tree .p-treenode-droppoint-active{border:0 none}.p-tree-horizontal{width:auto;padding-left:0;padding-right:0;overflow:auto}.p-tree.p-tree-horizontal table,.p-tree.p-tree-horizontal tr,.p-tree.p-tree-horizontal td{border-collapse:collapse;margin:0;padding:0;vertical-align:middle}.p-tree-horizontal .p-treenode-content{font-weight:400;padding:.4em 1em .4em .2em;display:flex;align-items:center}.p-tree-horizontal .p-treenode-parent .p-treenode-content{font-weight:400;white-space:nowrap}.p-tree.p-tree-horizontal .p-treenode{background:url(data:image/gif;base64,) repeat-x scroll center center transparent;padding:.25rem 2.5rem}.p-tree.p-tree-horizontal .p-treenode.p-treenode-leaf,.p-tree.p-tree-horizontal .p-treenode.p-treenode-collapsed{padding-right:0}.p-tree.p-tree-horizontal .p-treenode-children{padding:0;margin:0}.p-tree.p-tree-horizontal .p-treenode-connector{width:1px}.p-tree.p-tree-horizontal .p-treenode-connector-table{height:100%;width:1px}.p-tree.p-tree-horizontal .p-treenode-connector-line{background:url(data:image/gif;base64,) repeat-y scroll 0 0 transparent;width:1px}.p-tree.p-tree-horizontal table{height:0}.p-scroller .p-tree-container{overflow:visible}}\n"] }]
...
class TreeModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: TreeModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: TreeModule, imports: [CommonModule, SharedModule, RippleModule, ScrollerModule, CheckIcon, ChevronDownIcon, ChevronRightIcon, MinusIcon, SearchIcon, SpinnerIcon, PlusIcon, SharedModule, ScrollerModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: TreeModule, decorators: [{
            type: NgModule,
            args: [{
