...
import { inject, ElementRef, EventEmitter, booleanAttribute, numberAttribute, ViewChild, Output, Input, ViewEncapsulation, Component, signal, computed, ChangeDetectionStrategy, ChangeDetectorRef, ContentChildren, NgModule } from '@angular/core';
...
class PanelMenuSub {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: PanelMenuSub, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.9", type: PanelMenuSub, isStandalone: false, selector: "p-panelMenuSub", inputs: { panelId: "panelId", focusedItemId: "focusedItemId", items: "items", itemTemplate: "itemTemplate", level: ["level", "level", numberAttribute], activeItemPath: "activeItemPath", root: ["root", "root", booleanAttribute], tabindex: ["tabindex", "tabindex", numberAttribute], transitionOptions: "transitionOptions", parentExpanded: ["parentExpanded", "parentExpanded", booleanAttribute] }, outputs: { itemToggle: "itemToggle", menuFocus: "menuFocus", menuBlur: "menuBlur", menuKeyDown: "menuKeyDown" }, host: { classAttribute: "p-element" }, viewQueries: [{ propertyName: "listViewChild", first: true, predicate: ["list"], descendants: true }], ngImport: i0, template: `
        <ul
          #list
          ...
          @for (processedItem of items; track processedItem; let index = $index) {
            @if (processedItem.separator) {
              <li class="p-menuitem-separator" role="separator"></li>
            }
            @if (!processedItem.separator && isItemVisible(processedItem)) {
              <li
                        ...
                        @if (isItemGroup(processedItem)) {
                          @if (!panelMenu.submenuIconTemplate) {
                            @if (isItemActive(processedItem)) {
                              <AngleDownIcon [styleClass]="'p-submenu-icon'" [ngStyle]="getItemProp(processedItem, 'iconStyle')" />
                            }
                            @if (!isItemActive(processedItem)) {
                              <AngleRightIcon [styleClass]="'p-submenu-icon'" [ngStyle]="getItemProp(processedItem, 'iconStyle')" />
                            }
                          }
                          <ng-template *ngTemplateOutlet="panelMenu.submenuIconTemplate"></ng-template>
                        }
                        @if (processedItem.icon) {
                          <span class="p-menuitem-icon" [ngClass]="processedItem.icon" [ngStyle]="getItemProp(processedItem, 'iconStyle')"></span>
                        }
                        @if (processedItem.item?.escape !== false) {
                          <span class="p-menuitem-text">{{ getItemProp(processedItem, 'label') }}</span>
                        } @else {
                          <span class="p-menuitem-text" [innerHTML]="getItemProp(processedItem, 'label')"></span>
                        }
                        @if (processedItem.badge) {
                          <span class="p-menuitem-badge" [ngClass]="processedItem.badgeStyleClass">{{ processedItem.badge }}</span>
                        }
                      </a>
                    }
                    @if (getItemProp(processedItem, 'routerLink')) {
                      <a
                        ...
                        @if (getItemProp(processedItem, 'escape') !== false) {
                          <span class="p-menuitem-text">{{ getItemProp(processedItem, 'label') }}</span>
                        } @else {
                          <span class="p-menuitem-text" [innerHTML]="getItemProp(processedItem, 'label')"></span>
                        }
                        @if (processedItem.badge) {
                          <span class="p-menuitem-badge" [ngClass]="getItemProp(processedItem, 'badgeStyleClass')">{{ getItemProp(processedItem, 'badge') }}</span>
                        }
                      </a>
                    }
                  }
                ...
                <div class="p-toggleable-content" [@submenu]="getAnimation(processedItem)" (@submenu.done)="onToggleDone()">
                  @if (isItemVisible(processedItem) && isItemGroup(processedItem) && (isItemExpanded(processedItem) || animating)) {
                    <p-panelMenuSub
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: PanelMenuSub, decorators: [{
            type: Component,
            args: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: PanelMenuList, decorators: [{
            type: Component,
    ...
    `, changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None, host: {
                        class: 'p-element'
                    }, standalone: false, styles: ["@layer primeng{.p-panelmenu .p-panelmenu-header-action{display:flex;align-items:center;-webkit-user-select:none;user-select:none;cursor:pointer;position:relative;text-decoration:none}.p-panelmenu .p-panelmenu-header-action:focus{z-index:1}.p-panelmenu .p-submenu-list{margin:0;padding:0;list-style:none}.p-panelmenu .p-menuitem-link{display:flex;align-items:center;-webkit-user-select:none;user-select:none;cursor:pointer;text-decoration:none;position:relative;overflow:hidden;outline:none}.p-panelmenu .p-menuitem-text{line-height:1}.p-panelmenu-expanded.p-toggleable-content:not(.ng-animating),.p-panelmenu .p-submenu-expanded:not(.ng-animating){overflow:visible}.p-panelmenu .p-toggleable-content,.p-panelmenu .p-submenu-list{overflow:hidden}}\n"] }]
        }], propDecorators: { panelId: [{
                type: Input
            }], id: [{
                type: Input
        ...
        <div [class]="styleClass" [ngStyle]="style" [ngClass]="'p-panelmenu p-component'" #container>
          @for (item of model; track item; let f = $first; let l = $last; let i = $index) {
            @if (isItemVisible(item)) {
              <div class="p-panelmenu-panel" [ngClass]="getItemProp(item, 'headerClass')" [ngStyle]="getItemProp(item, 'style')" [attr.data-pc-section]="'panel'">
                <div
                    ...
                    @if (!itemTemplate) {
                      @if (!getItemProp(item, 'routerLink')) {
                        <a
                          ...
                          @if (item.icon) {
                            <span class="p-menuitem-icon" [ngClass]="item.icon" [ngStyle]="getItemProp(item, 'iconStyle')"></span>
                          }
                          ...
                          @if (getItemProp(item, 'badge')) {
                            <span class="p-menuitem-badge" [ngClass]="getItemProp(item, 'badgeStyleClass')">{{ getItemProp(item, 'badge') }}</span>
                          }
                        </a>
                      }
                    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: PanelMenu, decorators: [{
            type: Component,
...
class PanelMenuModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: PanelMenuModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.9", ngImport: i0, type: PanelMenuModule, declarations: [PanelMenu, PanelMenuSub, PanelMenuList], imports: [CommonModule, RouterModule, TooltipModule, SharedModule, AngleDownIcon, AngleRightIcon, ChevronDownIcon, ChevronRightIcon], exports: [PanelMenu, RouterModule, TooltipModule, SharedModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: PanelMenuModule, imports: [CommonModule, RouterModule, TooltipModule, SharedModule, AngleDownIcon, AngleRightIcon, ChevronDownIcon, ChevronRightIcon, RouterModule, TooltipModule, SharedModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: PanelMenuModule, decorators: [{
            type: NgModule,
            args: [{
