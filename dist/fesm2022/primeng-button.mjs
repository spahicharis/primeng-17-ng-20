...
import { inject, ElementRef, booleanAttribute, Input, Directive, EventEmitter, numberAttribute, ContentChildren, Output, ViewEncapsulation, ChangeDetectionStrategy, Component, NgModule } from '@angular/core';
...
class ButtonDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: ButtonDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.9", type: Button, isStandalone: true, selector: "p-button", inputs: { type: "type", iconPos: "iconPos", icon: "icon", badge: "badge", label: "label", disabled: ["disabled", "disabled", booleanAttribute], loading: ["loading", "loading", booleanAttribute], loadingIcon: "loadingIcon", raised: ["raised", "raised", booleanAttribute], rounded: ["rounded", "rounded", booleanAttribute], text: ["text", "text", booleanAttribute], plain: ["plain", "plain", booleanAttribute], severity: "severity", outlined: ["outlined", "outlined", booleanAttribute], link: ["link", "link", booleanAttribute], tabindex: ["tabindex", "tabindex", numberAttribute], size: "size", style: "style", styleClass: "styleClass", badgeClass: "badgeClass", ariaLabel: "ariaLabel", autofocus: ["autofocus", "autofocus", booleanAttribute] }, outputs: { onClick: "onClick", onFocus: "onFocus", onBlur: "onBlur" }, host: { properties: { "class.p-disabled": "disabled || loading" }, classAttribute: "p-element" }, queries: [{ propertyName: "templates", predicate: PrimeTemplate }], ngImport: i0, template: `
        <button
          ...
          @if (loading) {
            ...
            @if (loadingIconTemplate) {
              <ng-template *ngTemplateOutlet="loadingIconTemplate; context: { class: iconClass() }"></ng-template>
            }
          }
          @if (!loading) {
            @if (icon && !iconTemplate) {
              <span [ngClass]="iconClass()" [attr.data-pc-section]="'icon'"></span>
            }
            @if (!icon && iconTemplate) {
              <ng-template *ngTemplateOutlet="iconTemplate; context: { class: iconClass() }"></ng-template>
            }
          }
          @if (!contentTemplate && label) {
            <span class="p-button-label" [attr.aria-hidden]="icon && !label" [attr.data-pc-section]="'label'">{{ label }}</span>
          }
          @if (!contentTemplate && badge) {
            <span [ngClass]="badgeStyleClass()" [class]="badgeClass" [attr.data-pc-section]="'badge'">{{ badge }}</span>
          }
        </button>
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: Button, decorators: [{
            ...
            args: [{
                    selector: 'p-button',
                    imports: [NgTemplateOutlet, NgStyle, NgClass, Ripple, AutoFocus, SpinnerIcon],
                    template: `
        <button
          [attr.type]="type"
          [attr.aria-label]="ariaLabel"
...
class ButtonModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.9", ngImport: i0, type: ButtonModule, imports: [ButtonDirective, Button], exports: [ButtonDirective, Button, SharedModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: ButtonModule, imports: [Button, SharedModule] });
}
