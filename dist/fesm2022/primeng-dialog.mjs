...
import { inject, PLATFORM_ID, ElementRef, Renderer2, NgZone, ChangeDetectorRef, EventEmitter, booleanAttribute, numberAttribute, ViewChild, ContentChildren, ContentChild, Output, Input, ViewEncapsulation, ChangeDetectionStrategy, Component, NgModule } from '@angular/core';
import { PrimeNGConfig, TranslationKeys, Header, Footer, PrimeTemplate, SharedModule } from 'primeng/api';
                  ...
                  @if (showHeader) {
                    <div #titlebar class="p-dialog-header" (mousedown)="initDrag($event)">
                      @if (!headerFacet && !headerTemplate) {
                        <span [id]="ariaLabelledBy" class="p-dialog-title">{{ header }}</span>
                      }
                      @if (headerFacet) {
                        <span [id]="ariaLabelledBy" class="p-dialog-title">
...
class DialogModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.9", ngImport: i0, type: DialogModule, declarations: [Dialog], imports: [CommonModule, FocusTrapModule, ButtonModule, RippleModule, TimesIcon, WindowMaximizeIcon, WindowMinimizeIcon], exports: [Dialog, SharedModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: DialogModule, imports: [CommonModule, FocusTrapModule, ButtonModule, RippleModule, TimesIcon, WindowMaximizeIcon, WindowMinimizeIcon, SharedModule] });
}
