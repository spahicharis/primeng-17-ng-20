...
import { AfterContentInit, ChangeDetectorRef, EventEmitter, QueryList, ElementRef, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
declare class Dock implements AfterContentInit {
    private el;
