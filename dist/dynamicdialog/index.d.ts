...
import { Type, ViewContainerRef, AfterViewInit, OnDestroy, Renderer2, NgZone, ComponentRef, ElementRef, Injector, ProviderToken, InjectOptions } from '@angular/core';
 ...
 * @group Components
 */
declare class DynamicDialogConfig<T = any> {
    /**
...
declare class DynamicDialogComponent implements AfterViewInit, OnDestroy {
    private document;
    private platformId;
    private cd;
    renderer: Renderer2;
...
declare class DynamicDialogModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DynamicDialogModule, [typeof DynamicDialogComponent, typeof DynamicDialogContent], [typeof i2.CommonModule, typeof i3.WindowMaximizeIcon, typeof i4.WindowMinimizeIcon, typeof i5.TimesIcon, typeof i6.SharedModule, typeof i7.FocusTrapModule], [typeof i6.SharedModule]>;
...
declare class DynamicDialogInjector implements Injector {
    ...
    get<T>(token: ProviderToken<T>, notFoundValue?: T, options?: InjectOptions | {
        optional: true;
        host: true;
        skipSelf: true;
    }): T;
