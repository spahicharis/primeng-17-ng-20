...
import { TemplateRef, AfterContentInit, OnDestroy, ElementRef, ViewContainerRef, ChangeDetectorRef, QueryList, EmbeddedViewRef, AfterViewChecked, EventEmitter } from '@angular/core';
import * as i2 from 'primeng/api';
import { PrimeTemplate, BlockableUI } from 'primeng/api';
 ...
 * @group Components
 */
declare class TabPanel implements AfterContentInit, OnDestroy {
    el: ElementRef<any>;
 ...
 * @group Components
 */
declare class TabView implements AfterContentInit, AfterViewChecked, OnDestroy, BlockableUI {
    private platformId;
    el: ElementRef<any>;
    cd: ChangeDetectorRef;
    private renderer;
...
export type { TabViewChangeEvent, TabViewCloseEvent, TabViewTemplates };
