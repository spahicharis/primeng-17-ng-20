...
import { TemplateRef, AfterContentInit, ElementRef, NgZone, ChangeDetectorRef, EventEmitter, QueryList, SimpleChanges } from '@angular/core';
 ...
 * @group Components
 */
declare class Carousel implements AfterContentInit {
    el: ElementRef<any>;
    zone: NgZone;
    ...
    private platformId;
    private config;
    private updateSlideAccessibility;
    private updateCarouselItemsAccessibility;
    /**
