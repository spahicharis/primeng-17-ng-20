...
import { ElementRef, Renderer2, OnInit, AfterContentInit, OnDestroy, ChangeDetectorRef, TemplateRef, EventEmitter, QueryList } from '@angular/core';
import { AnimationEvent } from '@angular/animations';
import * as i6 from 'primeng/api';
import { PrimeNGConfig, OverlayService, MenuItem, PrimeTemplate } from 'primeng/api';
 ...
 * @group Components
 */
declare class SlideMenu implements OnInit, AfterContentInit, OnDestroy {
    private document;
    private platformId;
    el: ElementRef<any>;
    renderer: Renderer2;
    ...
    onMenuFocus(): void;
    onMenuBlur(): void;
    activeLevel: i0.WritableSignal<number>;
...
export type { SlideMenuTemplates };
