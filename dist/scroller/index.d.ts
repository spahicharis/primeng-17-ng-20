...
import { TemplateRef, OnInit, AfterContentInit, AfterViewChecked, OnDestroy, EventEmitter, ElementRef, QueryList, SimpleChanges } from '@angular/core';
 ...
 * @group Components
 */
declare class Scroller implements OnInit, AfterContentInit, AfterViewChecked, OnDestroy {
    private document;
    private platformId;
    private renderer;
    private cd;
