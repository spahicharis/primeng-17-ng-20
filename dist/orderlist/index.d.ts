...
import { TemplateRef, AfterViewChecked, AfterContentInit, ElementRef, ChangeDetectorRef, EventEmitter, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class OrderList implements AfterViewChecked, AfterContentInit {
    private document;
    private platformId;
    private renderer;
    el: ElementRef<any>;
