...
import { TemplateRef, AfterContentInit, OnInit, OnDestroy, ElementRef, ChangeDetectorRef, EventEmitter, QueryList } from '@angular/core';
import * as i2 from 'primeng/api';
import { FilterService, PrimeNGConfig, ScrollerOptions, PrimeTemplate } from 'primeng/api';
 ...
 * @group Components
 */
declare class Listbox implements AfterContentInit, OnInit, ControlValueAccessor, OnDestroy {
    el: ElementRef<any>;
    ...
    _filterValue: _angular_core.WritableSignal<string>;
...
declare class ListboxModule {
    ...
    static ɵmod: _angular_core.ɵɵNgModuleDeclaration<ListboxModule, [typeof Listbox], [typeof i1.CommonModule, typeof i2.SharedModule, typeof i3.RippleModule, typeof i4.ScrollerModule, typeof i5.SearchIcon, typeof i6.CheckIcon], [typeof Listbox, typeof i2.SharedModule, typeof i4.ScrollerModule]>;
    static ɵinj: _angular_core.ɵɵInjectorDeclaration<ListboxModule>;
}

export { LISTBOX_VALUE_ACCESSOR, Listbox, ListboxModule };
export type { ListboxChangeEvent, ListboxClickEvent, ListboxDoubleClickEvent, ListboxFilterEvent, ListboxFilterOptions, ListboxSelectAllChangeEvent, ListboxTemplates };
