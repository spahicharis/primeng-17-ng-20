...
import { AfterViewInit, AfterContentInit, OnDestroy, ChangeDetectorRef, EventEmitter, ElementRef, QueryList, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
declare class SpeedDial implements AfterViewInit, AfterContentInit, OnDestroy {
    private platformId;
    private el;
