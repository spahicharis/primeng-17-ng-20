...
import { AfterViewInit, OnDestroy, ElementRef, AfterContentInit, EventEmitter, TemplateRef, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class ButtonDirective implements AfterViewInit, OnDestroy {
    el: ElementRef<any>;
    private document;
    /**
 ...
 * @group Components
 */
declare class Button implements AfterContentInit {
    el: ElementRef<any>;
    /**
     * Type of the button.
     * @group Props
