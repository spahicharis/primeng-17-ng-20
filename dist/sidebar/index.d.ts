...
import { AfterViewInit, AfterContentInit, OnDestroy, ElementRef, Renderer2, ChangeDetectorRef, TemplateRef, QueryList, EventEmitter } from '@angular/core';
 ...
 * @group Components
 */
declare class Sidebar implements AfterViewInit, AfterContentInit, OnDestroy {
    private document;
    el: ElementRef<any>;
    renderer: Renderer2;
