...
import { OnInit, OnDestroy, ElementRef, Renderer2, TemplateRef, EventEmitter, AfterContentInit, ChangeDetectorRef, QueryList } from '@angular/core';
import * as rxjs from 'rxjs';
import { Subject, Subscription } from 'rxjs';
import * as i5 from 'primeng/api';
import { PrimeNGConfig, MenuItem, PrimeTemplate } from 'primeng/api';
...
declare class MenubarSub implements OnInit, OnDestroy {
    el: ElementRef<any>;
    renderer: Renderer2;
    private cd;
 ...
 * @group Components
 */
declare class Menubar implements AfterContentInit, OnDestroy, OnInit {
    private document;
    private platformId;
    el: ElementRef<any>;
    renderer: Renderer2;
