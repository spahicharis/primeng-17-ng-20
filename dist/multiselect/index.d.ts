...
import { ScrollerOptions, PrimeNGConfig, FilterService, OverlayService, OverlayOptions, PrimeTemplate } from 'primeng/api';
 ...
 * @group Components
 */
declare class MultiSelect implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    el: ElementRef<any>;
    renderer: Renderer2;
