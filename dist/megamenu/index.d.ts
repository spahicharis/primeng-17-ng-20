...
import { ElementRef, AfterContentInit, OnDestroy, OnInit, Renderer2, ChangeDetectorRef, QueryList, TemplateRef, EventEmitter } from '@angular/core';
import * as i5 from 'primeng/api';
import { PrimeNGConfig, MegaMenuItem, PrimeTemplate, MenuItem } from 'primeng/api';
 ...
 * @group Components
 */
declare class MegaMenu implements AfterContentInit, OnDestroy, OnInit {
    private document;
    private platformId;
    el: ElementRef<any>;
    renderer: Renderer2;
