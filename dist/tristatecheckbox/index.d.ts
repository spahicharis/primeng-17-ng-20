 ...
 * @group Templates
 */
interface TriStateCheckboxTemplates {
    /**
 ...
 * @group Events
 */
interface TriStateCheckboxChangeEvent {
    /**
     * Browser event.
     */
    originalEvent: Event;
...
declare const TRISTATECHECKBOX_VALUE_ACCESSOR: any;
/**
 * TriStateCheckbox is used to select either 'true', 'false' or 'null' as the value.
 * @group Components
 */
declare class TriStateCheckbox implements ControlValueAccessor {
    private cd;
...
declare class TriStateCheckboxModule {
...
export type { TriStateCheckboxChangeEvent, TriStateCheckboxTemplates };
