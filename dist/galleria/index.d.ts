...
import { TemplateRef, OnChanges, OnDestroy, ElementRef, ChangeDetectorRef, EventEmitter, QueryList, SimpleChanges, DoCheck, OnInit, AfterContentChecked, AfterViewInit } from '@angular/core';
 ...
 * @group Components
 */
declare class Galleria implements OnChanges, OnDestroy {
    private document;
    platformId: Object;
...
declare class GalleriaContent implements DoCheck {
    galleria: Galleria;
    cd: ChangeDetectorRef;
    private differs;
    config: PrimeNGConfig;
...
declare class GalleriaItem implements OnChanges {
    galleria: Galleria;
    id: string | undefined;
    circular: boolean;
    value: any[] | undefined;
    ...
    ariaNextNavigationLabel(): string;
    ariaPreviousNavigationLabel(): string;
...
declare class GalleriaThumbnails implements OnInit, AfterContentChecked, AfterViewInit, OnDestroy {
    galleria: Galleria;
    private document;
    private platformId;
    private renderer;
