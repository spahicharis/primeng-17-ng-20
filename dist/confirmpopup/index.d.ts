...
import { AfterContentInit, OnDestroy, ElementRef, Renderer2, QueryList, TemplateRef } from '@angular/core';
import * as i3 from 'primeng/api';
import { PrimeNGConfig, OverlayService, PrimeTemplate, Confirmation } from 'primeng/api';
 ...
 * @group Components
 */
declare class ConfirmPopup implements AfterContentInit, OnDestroy {
    el: ElementRef<any>;
