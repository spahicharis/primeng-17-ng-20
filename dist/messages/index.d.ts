...
import { AfterContentInit, OnDestroy, ElementRef, ChangeDetectorRef, EventEmitter, QueryList, TemplateRef } from '@angular/core';
import * as i8 from 'primeng/api';
import { MessageService, Message, PrimeTemplate } from 'primeng/api';
 ...
 * @group Components
 */
declare class Messages implements AfterContentInit, OnDestroy {
...
declare class MessagesModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<MessagesModule, [typeof Messages], [typeof i1.CommonModule, typeof i2.RippleModule, typeof i3.CheckIcon, typeof i4.InfoCircleIcon, typeof i5.TimesCircleIcon, typeof i6.ExclamationTriangleIcon, typeof i7.TimesIcon, typeof i8.SharedModule], [typeof Messages, typeof i8.SharedModule]>;
