...
import { TemplateRef, OnInit, AfterViewInit, AfterContentInit, OnChanges, ElementRef, NgZone, ChangeDetectorRef, EventEmitter, QueryList, SimpleChanges, OnDestroy, AfterViewChecked, Renderer2 } from '@angular/core';
import * as i23 from 'primeng/api';
import { FilterMetadata, LazyLoadMeta, SortMeta, BlockableUI, FilterService, OverlayService, PrimeNGConfig, ScrollerOptions, TableState, PrimeTemplate, SelectItem } from 'primeng/api';
 ...
 * @group Events
 */
interface TableRowUnSelectEvent extends TableRowSelectEvent {
}
/**
 * Custom page event.
 ...
 * @group Events
 */
interface TableContextMenuSelectEvent {
    /**
     * Browser event.
     */
    originalEvent: Event;
 ...
 * @group Events
 */
interface TableContextMenuSelectionChangeEvent {
    /**
     * Row data.
     */
    data: any;
...
declare class TableService {
    ...
    private isHeaderCheckboxSelection;
    sortSource$: rxjs.Observable<SortMeta | SortMeta[]>;
    isHeaderCheckboxSelection$: rxjs.Observable<any>;
    ...
    onHeaderCheckboxSelection(value: any): void;
 ...
 * @group Components
 */
declare class Table implements OnInit, AfterViewInit, AfterContentInit, BlockableUI, OnChanges {
    private document;
    private platformId;
    private renderer;
    el: ElementRef<any>;
...
declare class FrozenColumn implements AfterViewChecked {
    private el;
    private zone;
    get frozen(): boolean;
...
declare class SortableColumn implements OnInit, OnDestroy {
    dt: Table;
...
declare class SortIcon implements OnInit, OnDestroy {
    dt: Table;
    cd: ChangeDetectorRef;
    field: string | undefined;
    subscription: Subscription | undefined;
...
declare class SelectableRow implements OnInit, OnDestroy {
    dt: Table;
    tableService: TableService;
    private el;
    data: any;
...
declare class ResizableColumn implements AfterViewInit, OnDestroy {
    private document;
    private platformId;
    private renderer;
    dt: Table;
...
declare class ReorderableColumn implements AfterViewInit, OnDestroy {
    private platformId;
    private renderer;
    dt: Table;
    el: ElementRef<any>;
...
declare class CancelEditableRow {
    dt: Table;
    editableRow: EditableRow;
    onClick(event: Event): void;
...
declare class TableCheckbox {
    ...
    isTableHeaderCheckboxSelection: boolean;
    constructor();
    ngOnInit(): void;
    onClick(event: Event): void;
    onFocus(): void;
...
declare class TableHeaderCheckbox {
    dt: Table;
    tableService: TableService;
    cd: ChangeDetectorRef;
    disabled: boolean | undefined;
...
declare class ReorderableRowHandle implements AfterViewInit {
    el: ElementRef<any>;
    ngAfterViewInit(): void;
...
declare class ColumnFilter implements AfterContentInit {
    private document;
    el: ElementRef<any>;
    dt: Table;
    renderer: Renderer2;
...
declare class ColumnFilterFormElement implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ColumnFilterFormElement, "p-columnFilterFormElement", never, { "field": { "alias": "field"; "required": false; }; "type": { "alias": "type"; "required": false; }; "filterConstraint": { "alias": "filterConstraint"; "required": false; }; "filterTemplate": { "alias": "filterTemplate"; "required": false; }; "placeholder": { "alias": "placeholder"; "required": false; }; "minFractionDigits": { "alias": "minFractionDigits"; "required": false; }; "maxFractionDigits": { "alias": "maxFractionDigits"; "required": false; }; "prefix": { "alias": "prefix"; "required": false; }; "suffix": { "alias": "suffix"; "required": false; }; "locale": { "alias": "locale"; "required": false; }; "localeMatcher": { "alias": "localeMatcher"; "required": false; }; "currency": { "alias": "currency"; "required": false; }; "currencyDisplay": { "alias": "currencyDisplay"; "required": false; }; "useGrouping": { "alias": "useGrouping"; "required": false; }; "ariaLabel": { "alias": "ariaLabel"; "required": false; }; }, {}, never, never, false, never>;
    static ngAcceptInputType_minFractionDigits: unknown;
    static ngAcceptInputType_maxFractionDigits: unknown;
    static ngAcceptInputType_useGrouping: unknown;
}
 ...
 * @group Templates
 */
interface TableColumnFilterTemplates {
    /**
...
export type { ColumnFilterProps, ExportCSVOptions, TableColResizeEvent, TableColumnFilterTemplates, TableColumnReorderEvent, TableContextMenuSelectEvent, TableContextMenuSelectionChangeEvent, TableEditCancelEvent, TableEditCompleteEvent, TableEditEvent, TableEditInitEvent, TableFilterEvent, TableHeaderCheckboxToggleEvent, TableLazyLoadEvent, TablePageEvent, TableRowCollapseEvent, TableRowExpandEvent, TableRowReorderEvent, TableRowSelectEvent, TableRowUnSelectEvent, TableSelectAllChangeEvent, TableTemplates };
