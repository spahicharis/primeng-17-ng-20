...
import { TemplateRef, AfterContentInit, ChangeDetectorRef, ElementRef, EventEmitter, QueryList } from '@angular/core';
import * as i4 from 'primeng/api';
import { TreeNode, PrimeNGConfig, OverlayService, OverlayOptions, ScrollerOptions, PrimeTemplate } from 'primeng/api';
...
import * as i7 from 'primeng/icons/search';
 ...
 * @group Components
 */
declare class TreeSelect implements AfterContentInit {
    ...
    onOverlayBeforeHide(event: Event): void;
...
declare class TreeSelectModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<TreeSelectModule, [typeof TreeSelect], [typeof i1.CommonModule, typeof i2.OverlayModule, typeof i3.RippleModule, typeof i4.SharedModule, typeof i5.TreeModule, typeof i6.AutoFocusModule, typeof i7.SearchIcon, typeof i8.TimesIcon, typeof i9.ChevronDownIcon], [typeof TreeSelect, typeof i2.OverlayModule, typeof i4.SharedModule, typeof i5.TreeModule]>;
