...
import { AfterContentInit, OnInit, OnDestroy, ElementRef, Renderer2, NgZone, TemplateRef, EventEmitter, QueryList } from '@angular/core';
import * as i8 from 'primeng/api';
import { PrimeNGConfig, Header, Footer, PrimeTemplate } from 'primeng/api';
...
import * as i6 from 'primeng/icons/windowmaximize';
import * as i7 from 'primeng/icons/windowminimize';

/**
 * Dialog is a container to display content in an overlay window.
 * @group Components
 */
declare class Dialog implements AfterContentInit, OnInit, OnDestroy {
    private document;
    private platformId;
    el: ElementRef<any>;
    renderer: Renderer2;
