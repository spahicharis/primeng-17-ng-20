...
import { PrimeNGConfig, ConfirmEventType, PrimeTemplate, Confirmation } from 'primeng/api';
 ...
 * @group Components
 */
declare class ConfirmDialog implements AfterContentInit, OnInit, OnDestroy {
    el: ElementRef<any>;
    renderer: Renderer2;
