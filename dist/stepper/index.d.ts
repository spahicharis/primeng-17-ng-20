...
import { TemplateRef, QueryList, EventEmitter, AfterContentInit } from '@angular/core';
import * as i2 from 'primeng/api';
import { PrimeTemplate } from 'primeng/api';
import { Nullable } from 'primeng/ts-helpers';
import * as i1 from '@angular/common';

declare class StepperHeader {
    id: string | undefined;
...
declare class StepperSeparator {
    template: TemplateRef<any> | undefined;
 ...
 * @group Components
 */
declare class Stepper implements AfterContentInit {
    /**
 ...
 * @group Events
 */
interface ActiveStepChangeEvent {
    /**
     * Emitted when the value changes.
     */
...
export type { ActiveStepChangeEvent, StepperTemplates };
