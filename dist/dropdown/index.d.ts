...
import { TemplateRef, EventEmitter, OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ElementRef, Renderer2, ChangeDetectorRef, NgZone, Signal, QueryList } from '@angular/core';
import { AnimationEvent } from '@angular/animations';
import { ControlValueAccessor } from '@angular/forms';
import * as i3 from 'primeng/api';
import { ScrollerOptions, SelectItem, FilterService, PrimeNGConfig, OverlayOptions, PrimeTemplate } from 'primeng/api';
 ...
 * @group Events
 */
interface DropdownLazyLoadEvent {
    /**
...
declare const DROPDOWN_VALUE_ACCESSOR: any;
 ...
 * @group Components
 */
declare class Dropdown implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    el: ElementRef<any>;
    renderer: Renderer2;
...
export type { DropdownChangeEvent, DropdownFilterEvent, DropdownFilterOptions, DropdownLazyLoadEvent, DropdownTemplates };
