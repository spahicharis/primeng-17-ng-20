...
import { TemplateRef, OnInit, ElementRef, ChangeDetectorRef, EventEmitter, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class InputMask implements OnInit, ControlValueAccessor {
    private document;
    private platformId;
    el: ElementRef<any>;
