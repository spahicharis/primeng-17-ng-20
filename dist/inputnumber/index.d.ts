 ...
 * @group Components
 */
declare class InputNumber implements OnInit, AfterContentInit, OnChanges, ControlValueAccessor {
    private document;
    el: ElementRef<any>;
    private cd;
    ...
    get isBlurUpdateOnMode(): boolean;
