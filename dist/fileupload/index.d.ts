...
import { TemplateRef, AfterViewInit, AfterContentInit, OnInit, OnDestroy, NgZone, ChangeDetectorRef, EventEmitter, QueryList, ElementRef } from '@angular/core';
import { DomSanitizer } from '@angular/platform-browser';
import * as i2 from 'primeng/api';
import { BlockableUI, PrimeNGConfig, PrimeTemplate, Message } from 'primeng/api';
 ...
 * @group Components
 */
declare class FileUpload implements AfterViewInit, AfterContentInit, OnInit, OnDestroy, BlockableUI {
    private document;
    private platformId;
    private locale;
    private renderer;
