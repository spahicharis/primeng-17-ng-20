...
import { TemplateRef, OnInit, AfterContentInit, OnChanges, OnDestroy, ElementRef, EventEmitter, QueryList, SimpleChanges } from '@angular/core';
import * as i2 from 'primeng/api';
import { TreeNode, ScrollerOptions, BlockableUI, TreeDragDropService, PrimeNGConfig } from 'primeng/api';
...
declare class UITreeNode implements OnInit {
 ...
 * @group Components
 */
declare class Tree implements OnInit, AfterContentInit, OnChanges, OnDestroy, BlockableUI {
    el: ElementRef<any>;
...
export type { TreeFilterEvent, TreeLazyLoadEvent, TreeNodeCollapseEvent, TreeNodeContextMenuSelectEvent, TreeNodeDropEvent, TreeNodeExpandEvent, TreeNodeSelectEvent, TreeNodeUnSelectEvent, TreeScrollEvent, TreeScrollIndexChangeEvent, TreeTemplates };
