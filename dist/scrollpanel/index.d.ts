...
import { AfterViewInit, AfterContentInit, OnDestroy, ElementRef, NgZone, ChangeDetectorRef, QueryList, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
declare class ScrollPanel implements AfterViewInit, AfterContentInit, OnDestroy {
    private platformId;
    el: ElementRef<any>;
    zone: NgZone;
