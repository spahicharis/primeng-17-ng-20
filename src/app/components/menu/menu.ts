...
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChildren, ElementRef, EventEmitter, Input, NgModule, OnDestroy, Output, PLATFORM_ID, Pipe, PipeTransform, QueryList, Renderer2, TemplateRef, ViewChild, ViewEncapsulation, ViewRef, booleanAttribute, computed, effect, numberAttribute, signal, inject } from '@angular/core';
